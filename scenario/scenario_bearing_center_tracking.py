...
class ScenarioBearingbasedCenterTrackingConsensus:
    ...
    def __init__(self):
        self.name = "Drones Formation using Bearing-based Consensus Algorithm and Center tracking"
    ...
    def update(self, sim, model, data):
        ...
        match self.operation_mode:
            ...
            case "formation_icosahedron":
                ...
                if e_bearing_norm < self.e_bearing_tol:
                    ...
                    self.X_virtual_2 = self.X_virtual  + self.formation_controller.X_ref[-2]
                    self.dX_virtual_2 = np.array([0.0, 0.0, 0.0])
                    self.ddX_virtual_2 = np.array([0.0, 0.0, 0.0])
        ...
        for i in range(n_drones):
            ...
            if i == 0 and self.operation_mode == "cruise":
                pos_ref = self.path_tracking.look_ahead_point(self.X_virtual)    
